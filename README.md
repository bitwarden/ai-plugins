...
| [bitwarden-atlassian-tools](plugins/bitwarden-atlassian-tools/)     | 2.7.0   | Atlassian access via MCP server with deep Jira issue research skill, opt-in Jira write tools, and anchor-preserving Confluence page edits                   |
