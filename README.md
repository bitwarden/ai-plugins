...
| [bitwarden-design-tools](plugins/bitwarden-design-tools/)           | 0.1.0   | Apply Bitwarden brand identity (palette, typography, logo, 36px radius foundation) to standalone HTML deliverables, dashboards, and mockups           |
