...
| [bitwarden-atlassian-tools](plugins/bitwarden-atlassian-tools/)     | 2.7.2   | Atlassian access via MCP server with deep Jira issue research skill and opt-in Jira write tools                                                             |
