...
| ------------------------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [bitwarden-tech-lead](plugins/bitwarden-tech-lead/)                 | 2.3.3   | Tech lead for technical planning, architecture coherence, and surfacing patterns to Technical Strategy Ideas                                                |
...
| [bitwarden-delivery-tools](plugins/bitwarden-delivery-tools/)       | 3.0.0   | Delivery lifecycle skills: initiative funnel navigation, work transitions, commits, PRs, preflight, labeling                                                |
