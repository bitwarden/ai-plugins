...
| ------------------------------------------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [bitwarden-ai-telemetry](plugins/bitwarden-ai-telemetry/)           | 1.3.0   | Claude Code hooks emitting metadata-only AI-usage telemetry (session, identity, git-linkage, MCP) tagged with the signed-in account email via OTLP          |
...
| [bitwarden-atlassian-tools](plugins/bitwarden-atlassian-tools/)     | 2.7.3   | Atlassian access via MCP server with deep Jira issue research skill and opt-in Jira write tools                                                             |
...
| [bitwarden-delivery-tools](plugins/bitwarden-delivery-tools/)       | 3.2.0   | Delivery lifecycle skills: initiative funnel navigation, work transitions, architectural judgment, commits, PRs, preflight, labeling, Jira ticket filing    |
...
| [bitwarden-eval-tools](plugins/bitwarden-eval-tools/)               | 1.0.0   | Reusable trigger-rate eval runner for skills: installed and isolated modes, reliability-aware reporting, and an opt-in baseline regression check            |
