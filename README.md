...
| [bitwarden-eval-tools](plugins/bitwarden-eval-tools/)               | 1.1.0   | Tools for evaluating skills: trigger-rate evals with reliability-aware reporting and an opt-in baseline regression check, plus behavioral A/B evals with blind paired runs, ground-truth grading, and the ablation-accretion recipe |
