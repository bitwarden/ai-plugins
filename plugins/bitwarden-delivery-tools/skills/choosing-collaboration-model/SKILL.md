...
- **Reading another team's code without modifying it.** Not a cross-team change in this skill's sense. Pure consumption of an API or service needs no model (see `Skill(coordinating-cross-team-breakdown)` for the consumption-vs-extension distinction).
