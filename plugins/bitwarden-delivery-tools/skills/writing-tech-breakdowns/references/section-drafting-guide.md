...
- **Apply `Skill(architecting-solutions)` (in the `bitwarden-engineering-shaping` plugin) as the architectural lens** — blast-radius assessment, dual-data-access parity, V±2 client compatibility, multi-client reality.
