...
description: The tech lead's playbook for running ownership transitions in either direction — your team receiving work from another (initiative handoffs from shepherds, frameworks from Platform, operational responsibilities from SRE), or your team originating a transition (handing off a framework you built, transitioning a smaller initiative you shepherded, or moving operational responsibilities to another team). Applies Bitwarden's Work Transition Playbook from whichever side you're on. Use when your team is about to take on or hand off transferred work, when you're preparing materials or sessions, when the support period is underway, or when you need to run a pulse check or retrospective on a handoff.
---
...
- **Receiving side.** Another team is handing your team work. You're typically the named primary point of contact (the playbook calls this out explicitly — "typically a tech lead or senior engineer"). Your job is to evaluate what's being handed over, prepare your team to absorb it, and make the support period efficient.
- **Originating side.** Your team is handing work to another team. This is the case when your team built a framework or pattern intended for adoption by other teams, when you've shepherded a smaller-scope initiative through to implementation by another team, or when operational responsibilities are shifting. Your job is to prepare materials that make the receiving team self-sufficient and to support — not lead — once they've taken over.

The phases are the same on both sides; the responsibilities differ. Read both sections if you're going to be on both sides at different points in the same effort (common when shepherding a single-team-adjacent initiative).
...
You prepare the materials the receiving team will rely on. The bar isn't "everything you know is written down somewhere" — it's "a competent engineer on the receiving team could pick this up and work with it independently."
...
- **Known limitations, edge cases, and trade-offs you deliberately made.** These are the highest-value things to write down because they're the hardest to reconstruct later. Anything that would surprise a careful reader belongs here.
...
- **Ongoing maintenance ownership** after the support period. Default: the receiving team owns everything they adopt. For shared frameworks, you may retain some maintenance — confirm explicitly where the boundary sits.
...
You run the sessions. Two minimum, 1–2 weeks apart.
...
You shift from leading to supporting. Typical duration: 4–8 weeks, proportional to complexity. The mental model: **available, not assigned**.

What you do during the support period:

- Be reachable asynchronously — Slack, PR comments — for questions about approach, intent, or edge cases.
- Review 1–2 early PRs from the receiving team for alignment with the intended pattern. **Not as a gatekeeper.** You're catching misalignment while it's cheap to correct.
...
A practical note on **timing the handoff itself**: if you know the receiving team won't act on the work for some time, there's a case for deferring the formal sessions until closer to when they're ready, since context decays. But the general guideline is to run the sessions when the work is ready to hand off (context is freshest) and treat the support period as beginning when the receiving team starts active work. If there's a long gap, a brief re-orientation session at the point they pick it up restores context without keeping you continuously engaged.

### Phase 4 — Pulse Check (~30 days after transition)

You participate. Same questions as the receiving side — has work begun, are documents sufficient, is the support period sized right, is the team working around the approach in ways that suggest a mismatch.
...
You participate. 45–60 minutes, both teams. Goals: assess adoption, gather feedback on how the transition itself went, capture lessons for future transitions.

The most valuable output from the originating side: honest acknowledgment of what your documentation, sessions, or support failed to cover. Process improvements should feed back into the playbook itself — Bitwarden's transitions get better when teams add what they learned.

### Phase 6 — Closure

You acknowledge the transition is complete and step back. The signal matters: the receiving team is autonomous, and your involvement has concluded unless explicitly re-engaged. Don't linger as a "just-in-case" reviewer past closure — that's a soft form of refusing to let go.
...
- **Filling capacity gaps the receiving team should escalate.** If the receiving team isn't prioritizing the work, the right response is a leadership conversation about commitment, not quietly continuing the effort. You will undermine the transfer of ownership.
- **Skipping evaluation of phase-out cost.** The receiving team often knows what the old thing actually does in practice better than you do. Plan the decommissioning explicitly.
- **Treating the support period as continued ownership.** You're an advisor during this phase. Reviews are for alignment, not for approval. Merges are not yours.
- **Lingering past closure.** "I'll just keep watching for a while" is the soft form of refusing to let go. The receiving team should know exactly when they're autonomous.
...
- Related: `Skill(navigating-the-initiative-funnel)` for the initiative context that often triggers a transition; `Skill(architecting-solutions)` for the architectural judgment you apply when evaluating what's being handed over (in either direction).
