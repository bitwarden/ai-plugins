...
- **Self-contained report**: Writes a markdown coverage report — Overview, Summary, Evidence, Coverage, and Gaps — to a timestamped markdown file under `${CLAUDE_PLUGIN_DATA}/coverage-reports/`.
