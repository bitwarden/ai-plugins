...
| `bitwarden-implementer`       | The downstream implementer of tasks that fall out of a tech breakdown — drives one Jira task through plan → implement → validate → self-review → ship, ending at PR open |
