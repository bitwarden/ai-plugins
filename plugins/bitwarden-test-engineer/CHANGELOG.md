...
- Skill references for ingesting evidence (Jira, GitHub PR, Confluence tech breakdown, test-case CSV), finding and citing coverage, the Bitwarden repo/layer map, and the markdown report template.
