...
description: End-to-end playbook for shepherding a single cross-cutting initiative through Bitwarden's Software Initiative Funnel — Identification, Research, Proof of Concept, Scoping & Commitment, Implementation. Maps each phase's effort, deliverables, decision gate, and what the shepherd produces vs. what gets handed to teams. Dispatches to the phase-deep shepherd skills at the right moment. Use when starting an initiative, choosing which phase to advance, preparing for a decision gate, or holding the line on the shepherd vs. team ownership boundary.
