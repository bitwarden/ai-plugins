...
Phase 5 of the [Software Initiative Funnel](https://bitwarden.atlassian.net/wiki/spaces/EN/pages/584515614) is where teams do the work. **You are not doing the implementation.** You enable teams, maintain consistency, ensure the initiative completes successfully, and step back when it does.

This is also the support-period through closure portion of a [Work Transition Playbook](https://bitwarden.atlassian.net/wiki/spaces/EN/pages/2521038855) handoff from the originating side. Compose `Skill(running-work-transitions)` in `bitwarden-delivery-tools` for the canonical six-phase transition — Phases 3 (Support Period), 4 (Pulse Check ~30 days), 5 (Retrospective ~90 days), and 6 (Closure) all happen in this phase of the funnel. Read the originating-side guidance there; the rules about "available, not assigned" and "do not quietly resume the work" apply directly.

Time budget: 2–6 months wall clock; 10–20 hours/month of shepherd time. The funnel doc's mental model for what you are:
