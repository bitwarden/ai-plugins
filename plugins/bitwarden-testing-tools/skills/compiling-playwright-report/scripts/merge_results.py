...
# from one or more playwright-test-runner segment files. Concatenates the per-segment
...
def merge(segments):
    ...
    segments at each [HUMAN] pause, and a resumed playwright-test-runner legitimately emits
