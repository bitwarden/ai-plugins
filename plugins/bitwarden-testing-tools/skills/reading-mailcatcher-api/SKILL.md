...
| 1    | `NO_MATCH: no email for recipient …` — no matching message arrived (the script retried once after a 3s sleep)                      | the email has not arrived yet or the filters are too narrow; re-check `--recipient`, then widen or drop `--pattern`                                                                                                                                                                                                            |
...
| 3    | Mailcatcher unreachable or returned invalid JSON                                                                                   | Mailcatcher is not running or unreachable; start it (see Prerequisites), then retry                                                                                                                                                                                                                                            |
