...
**Required Claude Code skill:** Install the `playwright-cli` skill before using the web test pipeline. Every pipeline component reaches it as `Skill(playwright-cli)`. Render verification and all browser test execution depend on it.
