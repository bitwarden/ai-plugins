...
| 2    | `playwright-test-case-scoper`                                                                   | `app-context-<timestamp>.md`              |
