...
- Recorded both `baseline.json` files on `claude-opus-4-8`. Both skills pass every eval query: `recommending-test-layers` and `assessing-test-coverage` each at 10/10 should-trigger and 10/10 should-not-trigger.
