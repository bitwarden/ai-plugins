...
description: Use this skill to validate findings during Step 4 (Validate Findings). For each finding, run the rejection criteria and verification checks. If a finding fails any check, drop it.
---
