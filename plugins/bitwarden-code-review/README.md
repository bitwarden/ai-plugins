...
| [`generating-review-storybook`](./skills/generating-review-storybook/SKILL.md)             | "review storybook", "PR walkthrough", "stack walkthrough" | Generates a self-contained HTML walkthrough of a stack of PRs or commits — verdict-first, role-aware, with stakeholder-question handoffs |
