...
class SessionLogger:
    ...
    def __init__(self, session_id: str, cwd: str):
        ...
        # Use CLAUDE_PLUGIN_ROOT environment variable if available, otherwise fall back to cwd-relative path
        plugin_root = os.environ.get("CLAUDE_PLUGIN_ROOT")
        if plugin_root:
            self.logs_dir = Path(plugin_root) / "skills" / "retrospecting" / "logs"
        else:
