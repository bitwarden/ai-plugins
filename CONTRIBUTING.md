...
To run them locally before pushing, invoke them from a checkout of that repository — each accepts a plugin name or `plugins/<name>` path, and validates all plugins when given no arguments.
